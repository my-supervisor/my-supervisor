		                      ...
		                      <thead>
		                        <tr>
		                          ...
		                          <th colspan="3" class="text-right">							                
				              		<a href="/collect/aggregated-model/formular/extended-to-model-expression/source/edit?expr={item/id}&amp;model={model_id}&amp;formular={formular_id}" role="button" class="btn btn-sm btn-primary">

		                ...
		                <div class="col-md-12 mb-0">
		                     <div class="form-group">
		                       <label class="form-label">
		                       		Possibilités 
		                       		(<a href="/collect/aggregated-model/formular/case-expression/when-case/save?model={model_id}&amp;formular={formular_id}&amp;expression={item/id}" onclick="return confirm('Voulez-vous ajouter une nouvelle possibilité ?');">
		                       			<i class="fa fa-plus"></i> Nouvelle possibilité
		                       		 </a>)
		                       </label>
		                       <div class="table-responsive form-control">
				                    <table class="table card-table table-vcenter text-nowrap">

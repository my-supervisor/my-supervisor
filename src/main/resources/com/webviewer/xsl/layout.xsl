...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:layout="http://www.minlessika.com/Layout" exclude-result-prefixes="layout" version="2.0">	
	<xsl:template name="head">
		<head>
		    ...
		    <xsl:comment>Material Design for Bootstrap CSS</xsl:comment>
	   		...
	   		<link rel="stylesheet" href="/com/webviewer/vendors/mdbootstrap-4.5.3/css/mdb.min.css" />
	   
	   		<xsl:comment>Font Awesome for Icon CSS</xsl:comment>
	   		<link rel="stylesheet" href="/com/webviewer/vendors/fontawesome-free-5.15.1-web/css/all.min.css" />  		
	   		
	   		<xsl:comment>Toastr CSS</xsl:comment>
	   		<link rel="stylesheet" href="/com/webviewer/vendors/toastrjs/toastr.min.css" />
	   		
	   		<link rel="stylesheet" href="/com/webviewer/css/flag-icon-css/css/flag-icon.min.css" /> 
	...
	<xsl:template name="import-jslib">
		<xsl:comment>jQuery first, then Popper.js, then Bootstrap JS</xsl:comment>
   		<script src="/com/webviewer/vendors/mdbootstrap-4.5.3/js/jquery.min.js"></script>
   		<script src="/com/webviewer/vendors/toastrjs/toastr.min.js"></script>
   		<script src="/com/webviewer/vendors/mdbootstrap-4.5.3/js/popper.min.js"></script>
   		<script src="/com/webviewer/vendors/mdbootstrap-4.5.3/js/bootstrap.min.js"></script>
   		<script src="/com/webviewer/vendors/mdbootstrap-4.5.3/js/mdb.min.js"></script>		 

		...
		<form action="/admin/profile/save" method="post">
		    <xsl:if test="item and item/id">
	            <xsl:attribute name="action">
	              <xsl:text>/admin/profile/save?id=</xsl:text><xsl:value-of select="item/id"/>
	            </xsl:attribute>
	        </xsl:if>
			<div class="p-lg-6">
						         ...
						         <table class="table card-table table-vcenter text-nowrap">
						           <thead>
						             <tr>
						               ...
						               <th>Nb params</th>                
						               <th colspan="2">
						               		<a href="/admin/profile/access/no-added?profile={item/id}" class="btn btn-sm btn-primary pull-right"><i class="fa fa-plus"></i> Ajouter</a>
						               </th>
						             </tr>
						           </thead>
						           <tbody>

...
<xsl:stylesheet 
	...
	xmlns:interactive="http://www.minlessika.com/ReportViewComponent"
	version="2.0">
				...
				<div class="panel-heading clearfix">
					...
					<div class="pull-right">
						<div class="form-inline">
				            ...
				            <button type="button" class="btn btn-primary btn-sm mr-1" ng-disabled="pageNum == 1" ng-click="goPrevious()"><i class="fa fa-arrow-left"></i></button>
				            <button type="button" class="btn btn-primary btn-sm mr-1" ng-disabled="pageNum == pageCount" ng-click="goNext()"><i class="fa fa-arrow-right"></i></button>
				            <button type="button" class="btn btn-primary btn-sm mr-1" ng-click="zoomIn()"><i class="fe fe-zoom-in"></i></button>
				            <button type="button" class="btn btn-primary btn-sm mr-1" ng-click="fit()">100%</button>
				            <button type="button" class="btn btn-primary btn-sm" ng-click="zoomOut()"><i class="fe fe-zoom-out"></i></button>
			            </div>
					</div>	
				</div>
					...
					<div class="panel panel-default">
					    <div class="panel-body h-100" style="max-height: 1500px; overflow-y: scroll;">
					        <div ng-show="loadingData">
					            ...
					            <div class="col-xs-4">
					                <i class="fa fa-refresh fa-5x fa-spin"></i> <label class="label label-primary">Loading report...</label>
					            </div>
					            <div class="col-xs-4"></div>
					        </div>
					        <div id="viewer" ng-show="!loadingData">
								  <ng-pdf template-url="/com/accounting/html/viewer.html" scale="page-fit"></ng-pdf>
							</div>
					    </div>
					</div>
				</div>
	...
	<xsl:template name="viewer_logic">	
   		<script src="/com/webviewer/vendors/pdfjs-dist/build/pdf.combined.js"></script>
		<script src="/com/webviewer/vendors/angular-pdf/dist/angular-pdf.js"></script>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	<xsl:output method="html" cdata-section-elements="script style" include-content-type="no" doctype-system="about:legacy-compat" encoding="UTF-8" indent="yes"/>
	  ...
	  <body class="">
	    ...
	    <script src="/js/atmosphere.min.js"></script>
	    <script src="/js/angular-animate.min.js"></script>
	    <script src="/js/angular-touch.min.js"></script>
	    <script src="/js/guid.min.js"></script>
	    <script src="/js/bootstrap.bundle.min.js"></script>
	    <script src="/js/ui-bootstrap-tpls-3.0.4.min.js"></script>
	    <script src="/js/tagsinput.js"></script>
	    <script src="/js/angular_c3_simple.min.js"></script>
	    ...
	    <script src="/js/indicator_module.js"></script>

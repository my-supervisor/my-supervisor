...
import com.minlessika.sdk.pgsql.statement.PgSimpleUpdateStatement;
...
public class PgRecord<A1 extends Recordable> implements Record<A1> {
	...
	@Override
	public <T> T valueOf(MethodRefWithoutArg<A1> methodRef) throws IOException {  
	...
	@Override
	public Record<A1> entryOf(MethodRefWithoutArg<A1> methodRef, Object value) throws IOException {
	...
	@Override
	public void mustBeUnique(MethodRefWithoutArg<A1> methodRef, Object newValue, MethodRefWithoutArg<A1> fieldRef)
			throws IOException {
	...
	@SuppressWarnings("unchecked")
	@Override
	public <T extends Recordable> Record<T> of(MethodRefWithoutArg<A1> methodRef) throws IOException {

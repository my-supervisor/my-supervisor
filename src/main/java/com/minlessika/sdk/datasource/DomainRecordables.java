...
public class DomainRecordables<A1 extends Recordable, D extends DomainSet<A1, D>> implements DomainSet<A1, D> {
	...
	@Override
	public D where(MethodRefWithoutArg<A1> methodRef, Object value) throws IOException {
	...
	@Override
	public D where(MethodRefWithoutArg<A1> methodRef, Matcher matcher) throws IOException {
	...
	@Override
	public D orderBy(MethodRefWithoutArg<A1> methodRef, OrderDirection direction) throws IOException {
		return domainSetOf(source.orderBy(methodRef, direction));
	}

	@Override
	public D orderBy(MethodRefWithoutArg<A1> methodRef) throws IOException {
	...
	@Override
	public D orderBy(MethodRefWithoutArg<A1> methodRef1, MethodRefWithoutArg<A1> methodRef2,

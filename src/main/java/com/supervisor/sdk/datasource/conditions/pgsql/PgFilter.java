...
import com.supervisor.sdk.datasource.comparators.pgsql.PgSmartMatcher;
import com.supervisor.sdk.datasource.conditions.Condition;
import com.supervisor.sdk.datasource.conditions.Filter;
import com.supervisor.sdk.datasource.conditions.GroupedCondition;
...
public final class PgFilter<A1> implements Filter<A1> {
	...
	@Override
	public Filter<A1> add(final MethodReferenceUtils.MethodRefWithoutArg<A1> methodRef, final Matcher matcher) throws IOException {

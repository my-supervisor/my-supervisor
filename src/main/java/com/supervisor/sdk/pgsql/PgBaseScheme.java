...
public final class PgBaseScheme implements BaseScheme {
	...
	@Override
	public <T> FieldMetadata fieldOf(Class<T> clazz, MethodReferenceUtils.MethodRefWithoutArg<T> methodRef) throws IOException {
	...
	@Override
	public <T> String nameOf(Class<T> clazz, MethodReferenceUtils.MethodRefWithoutArg<T> methodRef) throws IOException {
		Method m = MethodReferenceUtils.getReferencedMethod(clazz, methodRef);
		return nameOfMethod(m);
	}

	@Override
	public <T> String labelOf(Class<T> clazz, MethodReferenceUtils.MethodRefWithoutArg<T> methodRef) throws IOException {
		Method m = MethodReferenceUtils.getReferencedMethod(clazz, methodRef);

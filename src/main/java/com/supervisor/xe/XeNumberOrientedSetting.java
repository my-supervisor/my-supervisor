...
public final class XeNumberOrientedSetting extends XeWrap {

	public XeNumberOrientedSetting(final String root, final NumberOriented item) throws IOException {
		this(transform(root, item));
	}
	
	public XeNumberOrientedSetting(final NumberOriented item) throws IOException {
		this("number_oriented_setting", item);
	}
	
	public XeNumberOrientedSetting(final Iterable<Directive> dir) {
		super(new XeSource() {
            @Override
	...
	private static Iterable<Directive> transform(final String root, final NumberOriented item) throws IOException {
		return new Directives()
                ...
                .add(
                	new CleanMap<String, Object>()
	                    ...
	                    .add("single_label", item.singleLabel())
	                    .add("plural_label", item.pluralLabel())
